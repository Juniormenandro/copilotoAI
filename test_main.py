...
from z_copiloto_agents import triage_agent
...
#             try:
#                 resposta = asyncio.run(Runner.run(triage_agent, input=user_message, context={"wa_id": wa_id}))
#                 resposta_texto = resposta.output if hasattr(resposta, "output") else str(resposta)

#                 salvar_mensagem(wa_id, "copiloto", resposta_texto)
#                 enviar_resposta(wa_id, resposta_texto)
#                 #processar_mensagem_usuario(user_message, wa_id)
#                 print(f"📤 Resposta enviada: {resposta_texto}")

#             except Exception as e:
#                 print(f"❌ Erro ao processar a mensagem: {e}")
#                 erro_resposta = "Tive um problema para processar sua mensagem. Pode tentar de novo?"
