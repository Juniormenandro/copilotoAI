...
mensagens_teste = [
    ...
    "Preciso criar um artigo para um blog de tecnologia voltado para iniciantes. noa sei se consigo!",
    ...
    "Agora desenvolva o primeiro tópico com exemplos práticos, e nao cansativo",

    # # Injeção emocional
    "Desculpa, tô um pouco cansado hoje... talvez esteja sobrecarregado.",
]

async def testar_emocional():
    wa_id = "353833844418"
    ...
    for i, mensagem in enumerate(mensagens_teste, 1):
        ...
        resposta = await Runner.run(
            emocional_comportamental_agent,
            input=mensagem,
            context=contexto
        )
